...
<div id="root-content" class="container">
    ...
    <div class="row">
        ...
        <div class="one-half column">
            <h2 class="">Knowledge is power</h2>
        ...
        <div class="one-half column">
            ...
            <div id="mc_embed_signup">
                <form action="//fhqk.us11.list-manage.com/subscribe/post?u=12c121183bb35ae627b098ba0&amp;id=44da274d95" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div id="mc_embed_signup_scroll">
                        <input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required />
                        <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                        <div style="position: absolute; left: -5000px;"><input type="text" name="b_12c121183bb35ae627b098ba0_44da274d95" tabindex="-1" value="" /></div>
