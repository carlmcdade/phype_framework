...
<?php echo "\n" .'<input' .
    ...
    (isset($value) && $value != '' ? ' value="' . $value . '"' : ' value="' . (isset($default) ? $default  : (new \DateTime())->format('Y-m-d H:i:s')) . '"').
    (isset($required) ? '<span class="required">' . $required . '</span>' : ''). '>'
?>
